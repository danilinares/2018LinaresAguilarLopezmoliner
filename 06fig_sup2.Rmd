...
p_fig_sup2 <- ggplot() +
  ...
  scale_color_manual(values = c("#e41a1c", "#006837", "#4daf4a","grey"),
                     breaks = c("zero", "sensory", "response", "no sym crit"),
                     labels = c("No bias", "Sensory bias", 
                                "Sensory + sym. decisional", 
                                "Sensory + asym. decisional"))  +
...
save_plot('figures/figuresupplementary2.pdf', p_fig_sup2, 
