...
sym_dev_s_vs_d <- 
  (fit_sym_no_two_guess_same_slope$deviance %>% semi_join(best_sym_no_two_guess_same_slope)) %>% 
  bind_rows((fit_sym_guess_same_slope$deviance %>% semi_join(best_sym_no_same_guess))) %>% 
  bind_rows((fit_sym_same_guess$deviance %>% semi_join(best_sym_no_absent_lapses_no_same_slope))) %>% 
  bind_rows((fit_sym_same_guess_same_slope$deviance %>% semi_join(best_sym_no_absent_lapses_same_slope))) %>% 
  bind_rows((fit_sym_absent_lapses$deviance %>% semi_join(best_sym_absent_lapses_no_same_slope))) %>% 
  bind_rows((fit_sym_absent_lapses_same_slope$deviance %>% semi_join(best_sym_absent_lapses_same_slope)))
